    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (otherCube != null && cube.CubeID > otherCube.CubeID)
        {
            ...
            if (cube.CubeNumber == otherCube.CubeNumber)
            {
                ...
                FXControler.Instance.PlayCubeExplosionFX(contactPoint,cube.CubeColor);
                
                // Destroy the tow cube
                CubeSpawner.Instance.DestroyCobe(cube);
                CubeSpawner.Instance.DestroyCobe(otherCube);
            }
        }
    }
}
